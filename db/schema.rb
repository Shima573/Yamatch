...
ActiveRecord::Schema[8.0].define(version: 2026_08_31_054006) do
  ...
  create_table "activity_records", force: :cascade do |t|
    ...
    t.index ["plan_id"], name: "index_activity_records_on_plan_id"
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["user_id", "mountain_id"], name: "index_favorites_on_user_id_and_mountain_id", unique: true
  ...
  add_foreign_key "activity_records", "plans"
